...
def init_patch_discriminator(checkpoints_path: Optional[str] = None, spatial_dims=3, in_channels=1,
                             num_layers_d=3) -> nn.Module:
    """
...
def init_latent_diffusion(args: Optional[str] = None, in_channels=4, use_image=True, spatial_dims=3) -> nn.Module:
    ...
    # except:
    # return load_if(args, latent_diffusion)
