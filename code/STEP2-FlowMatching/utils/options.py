...
# ---------------- Paths ----------------
parser.add_argument('--latent_dir', default="", type=str, help="Directory containing the dataset")
...
parser.add_argument('--img_dir', default="", type=str, help="Directory containing images")
