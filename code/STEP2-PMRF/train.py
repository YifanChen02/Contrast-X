...
parser.add_argument('--precision', type=str, required=False, choices=['bf16-mixed', "fp16-mixed", '32', "16", "16-mixed"],
...
def main(args):
    ...
    train_dataloader, train_data   = create_paired_dataloader(csv_path=args.dataset_csv, 
                                                          data_root=data_root, out_root=latent_root, target_dataset=target_dataset, 
                                                          split="train", batch_size=args.train_batch_size // args.num_gpus, spatial_size=spatial_size)
    val_dataloader,  val_data      = create_paired_dataloader(csv_path=args.dataset_csv, data_root=data_root, out_root=latent_root, target_dataset=target_dataset, 
                                                          split="test",  batch_size=4 * args.val_batch_size // args.num_gpus, spatial_size=spatial_size)
