...
def main(args):
    ...
    train_dataloader, train_data   = create_paired_dataloader(csv_path=args.dataset_csv, 
                                                          ...
                                                          split="train", batch_size=args.batch_size // args.num_gpus, spatial_size=spatial_size)
    val_dataloader,  val_data      = create_paired_dataloader(csv_path=args.dataset_csv, data_root=data_root, out_root=latent_root,
                                                          split="test",  batch_size=4 * args.batch_size // args.num_gpus, spatial_size=spatial_size)
