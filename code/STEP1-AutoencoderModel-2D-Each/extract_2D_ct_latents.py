...
if __name__ == '__main__':
    ...
    data_loader, train_ds     = create_paired_dataloader(csv_path=args.dataset_csv, split="test_all", 
    resolution=256, 
    ...
    # with torch.no_grad():
        ...
        for batch in tqdm(data_loader, total=len(data_loader)):
            ...
            zero_matrix      = torch.zeros_like(ctc).to(DEVICE)
            one_matrix       = torch.ones_like(ctc).to(DEVICE)
